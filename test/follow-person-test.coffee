    ...
    "and one user follows another":
      topic: (cl) ->
        ...
        Step (->
          ...
          accessToken cl,
            nickname: "moe"
            password: "bowlcutZ|are|cool"
          , @parallel()
          accessToken cl,
            nickname: "curly"
            password: "nyuk+nyuk+nyuk"
          , @parallel()
    ...
    "and one user follows a person who then posts":
      topic: (cl) ->
        ...
        Step (->
          ...
          accessToken cl,
            nickname: "jack"
            password: "up|the|hill"
          , @parallel()
          accessToken cl,
            nickname: "jill"
            password: "pail/of/water"
          , @parallel()
        ), ((err, pair1, pair2) ->
          throw err  if err
    ...
    "and a user posts a person to their following stream":
      topic: (cl) ->
        ...
        Step (->
          ...
          accessToken cl,
            nickname: "abbott"
            password: "what's|the|name"
          , @parallel()
          accessToken cl,
            nickname: "costello"
            password: "who's+on+3rd"
          , @parallel()
        ), ((err, pair1, pair2) ->
          throw err  if err
    ...
    "and a user posts to someone else's following stream":
      topic: (cl) ->
        ...
        Step (->
          ...
          accessToken cl,
            nickname: "hardy"
            password: "n0w,st4nley..."
          , @parallel()
          accessToken cl,
            nickname: "cop"
            password: "what's|the|hubbub"
          , @parallel()
        ), ((err, pair1, pair2, pair3) ->
          throw err  if err

...
testSchema =
  pkey: "id"
  fields: ["attachments", "author", "content", "displayName", "downstreamDuplicates", "id", "image", "objectType", "published", "summary", "updated", "upstreamDuplicates", "url", "_uuid", "compression", "data", "fileUrl", "length", "md5", "mimeType"]
  indices: ["_uuid"]
